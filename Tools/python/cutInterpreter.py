...
special_cuts = {
    ...
    "lep_SR_all_DL_sigeff":        "(Sum$(abs(lep_pdgId)==13&&(lep_pt>3.5)&&lep_pt<30&&abs(lep_eta)<2.4&& (lep_miniRelIso<0.4&&lep_sip3d<8&&abs(lep_dz)<0.1&&abs(lep_dxy)<0.05&&lep_pfMuonId&&lep_mediumMuonId&&lep_deepLeptonPrompt<999&&lep_deepLeptonPrompt>0.046 ) ) + Sum$(abs(lep_pdgId)==11&&lep_pt>5&&lep_pt<30&&abs(lep_eta)<2.5&& (lep_miniRelIso<0.4&&lep_sip3d<8&&abs(lep_dz)<0.1&&abs(lep_dxy)<0.05&&lep_lostHits<=1&&lep_deepLeptonPrompt<999&&lep_deepLeptonPrompt>0.082) )) == 2"   ,
    "lep_SR_all_DL_bgr":        "(Sum$(abs(lep_pdgId)==13&&(lep_pt>3.5)&&lep_pt<30&&abs(lep_eta)<2.4&& (lep_miniRelIso<0.4&&lep_sip3d<8&&abs(lep_dz)<0.1&&abs(lep_dxy)<0.05&&lep_pfMuonId&&lep_mediumMuonId&&lep_deepLeptonPrompt<999&&lep_deepLeptonPrompt>0.407 ) ) + Sum$(abs(lep_pdgId)==11&&lep_pt>5&&lep_pt<30&&abs(lep_eta)<2.5&& (lep_miniRelIso<0.4&&lep_sip3d<8&&abs(lep_dz)<0.1&&abs(lep_dxy)<0.05&&lep_lostHits<=1&&lep_deepLeptonPrompt<999&&lep_deepLeptonPrompt>0.864) )) == 2"   ,


    "lep_SR_mu_DL_sigeff":        "(Sum$(abs(lep_pdgId)==13&&(lep_pt>3.5)&&lep_pt<30&&abs(lep_eta)<2.4&& (lep_miniRelIso<0.4&&lep_sip3d<8&&abs(lep_dz)<0.1&&abs(lep_dxy)<0.05&&lep_pfMuonId&&lep_mediumMuonId&&lep_deepLeptonPrompt<999&&lep_deepLeptonPrompt>0.046 ) )) == 2"   ,
    "lep_SR_mu_DL_bgr":        "(Sum$(abs(lep_pdgId)==13&&(lep_pt>3.5)&&lep_pt<30&&abs(lep_eta)<2.4&& (lep_miniRelIso<0.4&&lep_sip3d<8&&abs(lep_dz)<0.1&&abs(lep_dxy)<0.05&&lep_pfMuonId&&lep_mediumMuonId&&lep_deepLeptonPrompt<999&&lep_deepLeptonPrompt>0.407 ) ) ) == 2"   ,
