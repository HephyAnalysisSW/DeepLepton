...
#testData
#python stacked_classes.py --flat --looseId --ptMin 10 --ptMax 25  --varSelection fullClasses --flatSample TTs_Muons_biLSTM_2016 --testData 
python stacked_classes.py --flat --looseId --ptMin 25 --ptMax 0   --varSelection fullClasses --flatSample TTs_Muons_biLSTM_2016 --testData 
#python stacked_classes.py --flat --looseId --ptMin 10 --ptMax 25  --varSelection fullClasses --flatSample TTs_Muons_noCNN_2016 --testData 
#python stacked_classes.py --flat --looseId --ptMin 25 --ptMax 0   --varSelection fullClasses --flatSample TTs_Muons_noCNN_2016 --testData 
