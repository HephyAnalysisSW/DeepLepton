...
in_path="/groups/hephy/cms/benjamin.wilhelmy/DeepLepton/predicted_on_sample/v9/${training_name}/2018/muo/pt_3.5_-1/"
...
sample=$sample4
python eff_table_dxy_pt.py --input_dir "${in_path}${sample}" --small
# syncWWW
