...
samplePromptSig.setSelectionString("lep_isPromptId_Training==1&&lep_probPrompt>{}".format(wp))
...
sampleNonPromptSig.setSelectionString("lep_isNonPromptId_Training==1&&lep_probPrompt>{}".format(wp))
...
sampleFakeSig.setSelectionString("lep_isFakeId_Training==1&&lep_probPrompt>{}".format(wp))
...
samplePromptBack.setSelectionString("lep_isPromptId_Training==1&&lep_probPrompt<{}".format(wp))
...
sampleNonPromptBack.setSelectionString("lep_isNonPromptId_Training==1==1&&lep_probPrompt<{}".format(wp))
...
sampleFakeBack.setSelectionString("lep_isFakeId_Training==1==1&&lep_probPrompt<{}".format(wp))
