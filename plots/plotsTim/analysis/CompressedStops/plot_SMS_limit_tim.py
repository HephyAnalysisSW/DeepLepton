...
#import sys
#import os.path
#__file__ = "/afs/hephy.at/work/t/tbrueckler/CMSSW_10_2_9/src/StopsDilepton/PlotsSMS2/python/"
...
#analysis_results = '/afs/hephy.at/data/cms03/tbrueckler/CompressedStops/cache2/caches/'
analysis_results = '/afs/hephy.at/data/cms03/tbrueckler/CompressedStops/cache_DL/caches/'


#defFile = os.path.join(analysis_results, "limits/SMS_T2tt/limitResults.root")
defFile = os.path.join(analysis_results, "limits/SMS_T2tt/limitResults_full_check_only6.root")
#defFile = os.path.join(analysis_results, "limits/SMS_T2tt/limitResults_full_old.root")
...
plotDir = os.path.join(plot_directory,'limits', signalString, options.version, yearString, options.subDir, 'DL3')
...
#            #print(mStop, mNeu, xSec, v)
#            #print(ix, iy, hists["obs_UL"].GetBinContent(ix,iy))
...
#for key in hists:
#    print(hists[key].GetEntries())

#for ix in range(hists[xSecKey].GetNbinsX()):
#    for iy in range(hists[xSecKey].GetNbinsY()):
#        print(hists["obs_UL_int"].GetBinContent(ix,iy))
        

print(hists)

#for i in ["exp", "exp_up", "obs", "obs_up", "obs_down"]:
for i in ["exp", "exp_up", "exp_down", "obs", "obs_up", "obs_down"]:
...
#from smsPlotXSEC import smsPlotXSEC
#from smsPlotCONT import smsPlotCONT
#from smsPlotBrazil import smsPlotBrazil
...
#print(fileIN.HISTOGRAM)#, fileIN.OBSERVED, fileIN.EXPECTED, fileIN.ENERGY, fileIN.LUMI, fileIN.PRELIMINARY)


#for ix in range(hists[xSecKey].GetNbinsX()):
#    for iy in range(hists[xSecKey].GetNbinsY()):
#        print(fileIN.HISTOGRAM["histogram"].GetBinContent(ix,iy))
