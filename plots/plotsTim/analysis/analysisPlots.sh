...
python -i analysisPlots_light.py --region low_sig  --noData --signal SMS --reduceMC 5 
python -i analysisPlots_light.py --region med_sig  --noData --signal SMS --reduceMC 5
python -i analysisPlots_light.py --region high_sig --noData --signal SMS --reduceMC 5
