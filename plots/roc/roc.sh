...
python -i roc.py --flat --ptMin 5  --ptMax 0   --flatSample TTs_Muons_globalVarsOnly_2016 --lumi_weight --testData 
python -i roc.py --flat --ptMin 25 --ptMax 0   --flatSample TTs_Muons_globalVarsOnly_2016 --lumi_weight --testData 
python -i roc.py --flat --ptMin 5  --ptMax 25  --flatSample TTs_Muons_globalVarsOnly_2016 --lumi_weight --testData 
python -i roc.py --flat --ptMin 10 --ptMax 25  --flatSample TTs_Muons_globalVarsOnly_2016 --lumi_weight --testData 
python -i roc.py --flat --ptMin 10 --ptMax 0   --flatSample TTs_Muons_globalVarsOnly_2016 --lumi_weight --testData 
python -i roc.py --flat --ptMin 10 --ptMax 250 --flatSample TTs_Muons_globalVarsOnly_2016 --lumi_weight --testData 
