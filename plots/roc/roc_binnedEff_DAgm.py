...
for relIsoCut in relIsoCuts:
    ...
    for ptCut in ptCuts:    
        ...
        kinematic_selection_latex = '#font[72]{p}_{T} > '+str(ptCut["lower_limit"])+' GeV' if ptCut["upper_limit"]==float("Inf") else str(ptCut["lower_limit"])+' GeV < #font[72]{p}_{T} < '+str(ptCut["upper_limit"])+' GeV'
        ...
        def drawObjects():
            ...
            tex.SetTextFont(62)
            tex.SetTextAlign(13)
            line = (0.12, 0.528, selection_latex)
            tex.DrawLatex(*line)
            line = (0.12, 0.488, kinematic_selection_latex)
            tex.DrawLatex(*line)
            ...
            tex.SetTextFont(42)
            tex.SetTextAlign(11)
            line = (0.10, 0.92, ("training info: {trainData}  -  {ref}".format( trainData=training_sampleInfo_latex, ref=flat_sampleInfo['training_name'] )))
            tex.DrawLatex(*line)
