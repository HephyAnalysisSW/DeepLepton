...
#TESTDATA
python -i roc_binnedEff_fixWP.py --flat --testData --flatSample TTs_Muons_endVar_2016 --lumi_weight --eS_TTV 90 --eS_DL 90 --binned high_pt
python -i roc_binnedEff_fixWP.py --flat --testData --flatSample TTs_Muons_endVar_2016 --lumi_weight --eS_TTV 90 --eS_DL 90 --binned low_pt
python -i roc_binnedEff_fixWP.py --flat --testData --flatSample TTs_Muons_endVar_2016 --lumi_weight --eS_TTV 90 --eS_DL 90 --binned pt

python -i roc_binnedEff_fixWP.py --flat --testData --flatSample TTs_Muons_endVar_2016 --lumi_weight --eS_TTV 90 --eS_DL 90 --binned eta
python -i roc_binnedEff_fixWP.py --flat --testData --flatSample TTs_Muons_endVar_2016 --lumi_weight --eS_TTV 90 --eS_DL 90 --binned nTrueInt
