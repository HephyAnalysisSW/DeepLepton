...
for lepton_id in lepton_ids:
    ...
    for kinematic_selection in kinematic_selections:
        ...
        lepton_id["roc_"+kinematic_selection["name"]].SetLineWidth(1)
        lepton_id["roc_"+kinematic_selection["name"]].SetLineColor(51)
        ...
        #lepton_id["roc_"+kinematic_selection["name"]].Draw(option+same+"L")
